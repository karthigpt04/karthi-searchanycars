    ...
    <div className={themeClass}>
      <div className="price-slider-header">
        ...
        <div
          ...
          style={{ color: isDark ? '#fff' : 'var(--navy, #1a2744)' }}
        >
          <span>{displayMin <= min ? formatLabel(min) : formatLabel(displayMin)}</span>
          <span className="price-slider-values-sep" style={{ color: labelColor }}>
            {' '}
            —{' '}
          </span>
      ...
      <div className="price-slider-track-area">
        ...
        >
          <div
            ...
            style={{ left: `${leftPct}%`, right: `${rightPct}%`, background: accentColor }}
          />
          <div
