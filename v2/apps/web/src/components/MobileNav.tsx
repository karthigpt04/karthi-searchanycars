  ...
  return (
    <nav className="mobile-nav" aria-label="Mobile navigation">
      <div className="mobile-nav-grid">
        ...
        <Link
          href="/splus"
          className={`mobile-nav-item ${isActive('/splus') && !isActive('/splus-new') ? 'active' : ''}`}
        >
        ...
        <Link
          href="/splus-new"
          className={`mobile-nav-item ${isActive('/splus-new') ? 'active' : ''}`}
        >
          <span className="mobile-nav-icon-wrap mnav-new">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path d="M19 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zm-3 10h-3v3a1 1 0 11-2 0v-3H8a1 1 0 110-2h3V8a1 1 0 112 0v3h3a1 1 0 110 2z" />
            </svg>
          </span>
          <span>New Cars</span>
        </Link>
        ...
        <Link
          href={user ? '/change-password' : '/login'}
          className={`mobile-nav-item ${isActive('/login') || isActive('/change-password') ? 'active' : ''}`}
        >
