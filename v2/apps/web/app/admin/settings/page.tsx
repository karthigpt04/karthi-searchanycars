...
import type { SiteConfig } from '../../../src/context/SiteConfigContext';
...
export default function AdminSettingsPage() {
  ...
  const data = formData as unknown as SiteConfig;
            ...
            {(data.trust_bar || []).map((item, i) => (
              <div key={i} className="adm-s-repeater-item">
                ...
                <div className="adm-s-item-actions">
                  {i > 0 && <button className="btn btn-ghost btn-sm" onClick={() => moveArrayItem('trust_bar', i, i - 1)} type="button">&uarr;</button>}
                  {i < (data.trust_bar?.length || 0) - 1 && <button className="btn btn-ghost btn-sm" onClick={() => moveArrayItem('trust_bar', i, i + 1)} type="button">&darr;</button>}
          ...
          <div className="adm-settings-panel">
            ...
            {(data.cities || []).map((city, i) => (
              <div key={i} className="adm-s-repeater-item">
                ...
                <div className="adm-s-item-actions">
                  {i > 0 && <button className="btn btn-ghost btn-sm" onClick={() => moveArrayItem('cities', i, i - 1)} type="button">&uarr;</button>}
          ...
          <div className="adm-settings-panel">
            ...
            {items.map((item, i) => (
              <div key={i} className="adm-s-repeater-item">
                ...
                <div className="adm-s-item-actions">
                  {i > 0 && <button className="btn btn-ghost btn-sm" onClick={() => moveArrayItem(arrKey, i, i - 1)} type="button">&uarr;</button>}
          ...
          <div className="adm-settings-panel">
            ...
            {(data.nav_items || []).map((item, i) => (
              <div key={i} className="adm-s-repeater-item">
                ...
                <div className="adm-s-item-actions">
                  {i > 0 && <button className="btn btn-ghost btn-sm" onClick={() => moveArrayItem('nav_items', i, i - 1)} type="button">&uarr;</button>}
                  {i < (data.nav_items?.length || 0) - 1 && <button className="btn btn-ghost btn-sm" onClick={() => moveArrayItem('nav_items', i, i + 1)} type="button">&darr;</button>}
          ...
          <div className="adm-settings-layout">
            <aside className="adm-settings-sidebar">
              {tabs.map(t => (
                <button
                  key={t.key}
                  className={`adm-settings-tab ${activeTab === t.key ? 'active' : ''}`}
