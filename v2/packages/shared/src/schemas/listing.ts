...
export const createListingSchema = z.object({
  ...
  estimatedMarketValueInr: z.number().int().min(0).optional(),
  ownershipType: z
  ...
  registrationCity: z.string().max(100).optional(),
  totalKmDriven: z.number().int().min(0).optional(),
  mileageKmpl: z.number().min(0).optional(),
  engineType: z.string().max(100).optional(),
  engineCapacityCc: z.number().int().min(0).optional(),
  powerBhp: z.number().int().min(0).optional(),
  transmissionType: z
  ...
  overallConditionRating: z.number().min(0).max(10).optional(),
  serviceHistoryAvailable: z.boolean().optional(),
  airbagsCount: z.number().int().min(0).optional(),
  infotainmentScreenSize: z.string().max(20).optional(),
  locationCity: z.string().max(100).optional(),
  locationState: z.string().max(100).optional(),
  dealerRating: z.number().min(0).max(5).optional(),
  inspectionStatus: z.string().max(30).optional(),
